					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="offer">
								<div class="heading">
									<!-- Heading -->
									<h2>Kurti Tops Products <span style="color:#000;font-weight:bold;">Saree House Fashion</span></h2>
								</div>
								...
								<ul id="preview" class="" style="padding:0; margin:0;">
									...
									<li class="offer-item element one">
										...
										<span class="slashc-img-zoom-pan">
											<img alt="Image 01" src="img/product/small/akt128-enlarge.jpg" />
											<img alt="Image 01" src="img/product/large/akt128-large.jpg" />
										</span>
										</a>
									
										<div class="offer-details">
										
											<h3><a href="product_details.php">Kurti Tops</a><a href="contact.php" class="btn btn-default pull-right">Buy Now</a><!--<span class="offer-price pull-right"> from $30.0</span>--></h3>
									...
									<li class="offer-item element four">
										<a href="product_details.php" title="View Detail" >						
										<span class="slashc-img-zoom-pan">
											<img alt="Image 02" src="img/product/small/akt121-enlarge.jpg" />
											<img alt="Image 02" src="img/product/large/akt121-large.jpg" />
										</span>
										</a>
										<!-- Offer Details -->
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Kurti Tops</a><a href="contact.php" class="btn btn-default pull-right">Buy Now</a><!--<span class="offer-price pull-right"> from $269.0</span>--></h3>
											<!-- Icons And Button -->
											<div class="offer-icons">
												<!-- Icons -->
									...
									<li class="offer-item element four">
										<a href="product_details.php" title="View Detail" >
										<span class="slashc-img-zoom-pan">
											<img alt="Image 01" src="img/product/small/akt122-enlarge.jpg" />
											<img alt="Image 01" src="img/product/large/akt122-large.jpg" />
										</span>
										</a>
										<!-- Offer Details -->
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Kurti Tops</a><a href="contact.php" class="btn btn-default pull-right">Buy Now</a><!--<span class="offer-price pull-right"> from $295.0</span>--></h3>
											<!-- Icons And Button -->
											<div class="offer-icons">
												<!-- Icons -->
									...
									<li class="offer-item element four">
										<a href="product_details.php" title="View Detail" >
										<span class="slashc-img-zoom-pan">
											<img alt="Image 01" src="img/product/small/tvt67-enlarge.jpg" />
											<img alt="Image 01" src="img/product/large/tvt67-large.jpg" />
										</span>
										</a>
										<!-- Offer Details -->
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Kurti Tops</a><a href="contact.php" class="btn btn-default pull-right">Buy Now</a><!--<span class="offer-price pull-right"> from $358.0</span>--></h3>
											<!-- Icons And Button -->
											<div class="offer-icons">
												<!-- Icons -->
									 ...
									 <li class="offer-item element four">
										<a href="product_details.php" title="View Detail" >
										<span class="slashc-img-zoom-pan">
											<img alt="Image 01" src="img/product/small/tcd51-enlarge.jpg" />
											<img alt="Image 01" src="img/product/large/tcd51-large.jpg" />
										</span>
										</a>
										<!-- Offer Details -->
										<div class="offer-details">
									 ...
									 <li class="offer-item element four">
										<a href="product_details.php" title="View Detail" >
										<span class="slashc-img-zoom-pan">
											<img alt="Image 01" src="img/product/small/tdr106-enlarge.jpg" />
											<img alt="Image 01" src="img/product/large/tdr106-large.jpg" />
										</span>
										</a>
										<!-- Offer Details -->
										<div class="offer-details">
									...
									<li class="offer-item element four">
										<a href="product_details.php" title="View Detail" >
										<span class="slashc-img-zoom-pan">
											<img alt="Image 01" src="img/product/small/akt124-enlarge.jpg" />
											<img alt="Image 01" src="img/product/large/akt124-large.jpg" />
										</span>
										</a>
										<!-- Offer Details -->
										<div class="offer-details">
									...
									<li class="offer-item element two">
										...
										<div class="offer-details">
											...
											<h3><a href="product_details.php">Kurti Tops</a><a href="contact.php" class="btn btn-default pull-right">Buy Now</a><!--<span class="offer-price pull-right"> from $69.0</span>--></h3>
