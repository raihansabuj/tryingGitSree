							...
							<!--	<ul id="filters">
								...
								<ul id="preview" class="" style="padding:0; margin:0;">
									...
									<li class="offer-item element four">
										...
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Bridal</a><a href="contact.php" class="btn btn-default pull-right">Buy Now</a><!--<span class="offer-price pull-right"> From $349.0</span>--></h3>
											<!-- Icons And Button -->
											<div class="offer-icons">
												<!-- Icons -->
									...
									<li class="offer-item element three">
										...
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Bridal</a><a href="contact.php" class="btn btn-default pull-right">Buy Now</a><!--<span class="offer-price pull-right"> From $129.0</span>--></h3>
											<!-- Icons And Button -->
											<div class="offer-icons">
												<!-- Icons -->
									...
									<li class="offer-item element four">
										...
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Bridal</a><a href="contact.php" class="btn btn-default pull-right">Buy Now</a><!--<span class="offer-price pull-right"> From $438.0</span>--></h3>
											<!-- Icons And Button -->
											<div class="offer-icons">
												<!-- Icons -->
												 <!--
