...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 08, 2015 at 01:01 PM
...
(16, '103', '1442378028.jpg', '20', '0', '16-09-2015 10:33:48 am', NULL);
...
CREATE TABLE IF NOT EXISTS `product_table` (
  ...
  `product_entry_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `product_update_date` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB AUTO_INCREMENT=105 DEFAULT CHARSET=armscii8 COLLATE=armscii8_bin;
...
(97, 'SH078', 'Blouse', '17', 234, '25', '', 'yes', 'yes', '21, 16', '3', '9', '1', '6', '8', 'Best quality Blouse..', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(98, 'SH011', 'Kurti Tops', '16', 5435, '25', '', 'no', 'yes', '16', '3', '5', '2', '5', '8', 'Best quality Kurti Tops', '0000-00-00 00:00:00', NULL),
(99, 'SH013', 'Casual', '14', 4534, '26', '', 'yes', 'yes', '19, 16, 15', '4', '5', '3', '5', '7', 'It is one of our luxurious prodct.', '0000-00-00 00:00:00', NULL),
(100, 'SH0114', 'Panjabi and Bedsheets', '18', 3454, '26', '', 'no', 'yes', '19, 16, 15', '3', '5', '3', '4', '7', 'It is one of our luxurious prodct.', '0000-00-00 00:00:00', NULL),
(101, '93247', 'Blouse 2', '17', 400, '25', '', 'yes', 'yes', '18, 17, 16', '3', '5', '.5', '5', '8', '', '0000-00-00 00:00:00', NULL),
(102, 'SH01142', 'Party', '15', 34324, '25', '', 'no', 'yes', '18, 17, 19, 16, 15', '3', '5', '2', '6', '8', 'It is one of our luxurious prodct.', '0000-00-00 00:00:00', NULL),
(103, 'SH01143', 'Benarashi', '13', 12345, '26', '', 'yes', 'yes', '18, 17, 19, 21, 16, 20, 22, 15, 23', '3', '', '3', '4', '7', '', '2015-10-08 07:06:08', '2015-10-08 07:06:08'),
(104, 'BN02', 'Weddng', '13', 30, '27', '', 'yes', 'yes', '17, 19, 16, 15', '5', '9, 10, 7, 8, 6', '', '7', '8', 'Saree  Multiple faux georgette saree designed with zari, sequins, stone, gota lace and patch border work. Available with black art silk and net blouse fabric, blouse shown in the image is just for photography purpose. (Slight variation in color and patch border work is possible.) Know Your Fabric  Loops, crinkles, pulled yarns, thread irregularities or missing yarns are inevitable features of Georgette. Such variations are natural characteristics of the fabric and add an aesthetic impact to it. Color  Shades displayed across the range of fabric and accessories may slightly vary from the actual color. This may happen due to multiple settings in your monitor or viewing device (Laptop/Mobile/Tab), or impact of our digital photo shoots. We request you to consider these minor color variations. ', '0000-00-00 00:00:00', NULL);
...
CREATE TABLE IF NOT EXISTS `review_product` (
  ...
  `review_entrydate` varchar(55) COLLATE armscii8_bin NOT NULL
...
INSERT INTO `review_product` (`id`, `product_id`, `name`, `email`, `rating`, `review`, `review_entrydate`) VALUES
...
(17, '103', '', '', '', '', ''),
(18, '97', 'your namedfdsf', 'tapolly01@gmai.com', '5', 'sdddddddddddddddddddd', ''),
(19, '103', 'sdsdfdsfdsf', 'towficr@yahoo.com', '4', 'sdfdsfds', '17-09-2015 18:07:35 pm');
...
--
ALTER TABLE `care`
  MODIFY `care_id` int(30) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10;
--
...
--
ALTER TABLE `product_color`
  MODIFY `product_color_id` int(30) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=24;
--
...
--
ALTER TABLE `product_table`
  MODIFY `product_id` int(30) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=105;
--
...
--
ALTER TABLE `shipping`
  MODIFY `shipping_id` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=28;
