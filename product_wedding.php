					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="offer">
								<div class="heading">
									<!-- Heading -->
									<h2>Wedding Products <span style="color:#000;font-weight:bold;">Saree House Fashion</span></h2>
								</div>
								...
								<ul id="preview" class="" style="padding:0; margin:0;">
									...
									<li class="offer-item element three">
										...
										<div class="offer-details">
											...
											<h3><a href="product_details.php">Wedding</a><span class="offer-price pull-right"> From $183.0</span></h3>
											<!-- Icons And Button -->
									...
									<li class="offer-item element three">
										...
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Wedding</a><span class="offer-price pull-right"> From $250.0</span></h3>
											<!-- Icons And Button -->
											<div class="offer-icons">
												<!-- Icons -->
									...
									<li class="offer-item element four">
										...
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Wedding</a><span class="offer-price pull-right"> From $310.0</span></h3>
											<!-- Icons And Button -->
											<div class="offer-icons">
												<!-- Icons -->
									...
									<li class="offer-item element four">
										...
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Wedding</a><span class="offer-price pull-right"> From $349.0</span></h3>
											<!-- Icons And Button -->
											<div class="offer-icons">
												<!-- Icons -->
									...
									<li class="offer-item element three">
										...
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Wedding</a><span class="offer-price pull-right"> From $129.0</span></h3>
											<!-- Icons And Button -->
											<div class="offer-icons">
												<!-- Icons -->
									...
									<li class="offer-item element three">
										...
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Wedding</a><span class="offer-price pull-right"> From $202.0</span></h3>
											<!-- Icons And Button -->
											<div class="offer-icons">
												<!-- Icons -->
									...
									<li class="offer-item element three">
										...
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Wedding</a><span class="offer-price pull-right"> From $102.0</span></h3>
											<!-- Icons And Button -->
											<div class="offer-icons">
												<!-- Icons -->
									...
									<li class="offer-item element three">
										...
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Wedding</a><span class="offer-price pull-right"> From $154.0</span></h3>
											<!-- Icons And Button -->
											<div class="offer-icons">
												<!-- Icons -->
									...
									<li class="offer-item element three">
										...
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Wedding</a><span class="offer-price pull-right"> From $162.0</span></h3>
											<!-- Icons And Button -->
											<div class="offer-icons">
												<!-- Icons -->
									...
									<li class="offer-item element three">
										...
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Wedding</a><span class="offer-price pull-right"> From $126.0</span></h3>
											<!-- Icons And Button -->
											<div class="offer-icons">
												<!-- Icons -->
									...
									<li class="offer-item element three">
										...
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Wedding</a><span class="offer-price pull-right"> From $172.0</span></h3>
											<!-- Icons And Button -->
											<div class="offer-icons">
												<!-- Icons -->
									...
									<li class="offer-item element three">
										...
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Wedding</a><span class="offer-price pull-right"> From $138.0</span></h3>
											<!-- Icons And Button -->
											<div class="offer-icons">
												<!-- Icons -->
									...
									<li class="offer-item element four">
										...
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Wedding</a><span class="offer-price pull-right"> From $438.0</span></h3>
											<!-- Icons And Button -->
											<div class="offer-icons">
												<!-- Icons -->
