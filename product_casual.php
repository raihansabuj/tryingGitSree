...
<html>
	...
	<body>
		...
		<audio controls autoplay loop  id="audioPlayer" class="">
		  <source src="audio/casual_tumi_robe_nirobe.ogg" type="audio/ogg">
		  <source src="audio/casual_tumi_robe_nirobe.mp3" type="audio/mpeg">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="offer">
								<div class="heading">
									<!-- Heading -->
									<h2>Casual Products <span style="color:#000;font-weight:bold;">Saree House Fashion</span></h2>
								</div>
								...
								<ul id="preview" class="" style="padding:0; margin:0;">
									...
									<li class="offer-item element four">
										...
										<div class="offer-details">
											...
											<h3><a href="product_details.php">Casual</a><a href="contact.php" class="btn btn-default pull-right">Buy Now</a><!--<span class="offer-price pull-right"> from $285.0</span>--></h3>
											<!-- Icons And Button -->
									...
									<li class="offer-item element four">
										<a href="product_details.php" title="View Detail" >
										<span class="slashc-img-zoom-pan">
											<img alt="Image 01" src="img/product/small/slsej172b-enlarge.jpg" />
											<img alt="Image 01" src="img/product/large/slsej172b-large.jpg" />
										</span>
										</a>
										<!-- Offer Details -->
										<div class="offer-details">
									...
									<li class="offer-item element two">
										<a href="product_details.php" title="View Detail" >						
										<span class="slashc-img-zoom-pan">
											<img alt="Image 02" src="img/product/small/sga5191-enlarge.jpg" />
											<img alt="Image 02" src="img/product/large/sga5191-large.jpg" />
										</span>
										</a>
										<!-- Offer Details -->
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Casual</a><a href="contact.php" class="btn btn-default pull-right">Buy Now</a><!--<span class="offer-price pull-right"> from $89.0</span>--></h3>
											<!-- Icons And Button -->
											<div class="offer-icons">
												<!-- Icons -->
									...
									<li class="offer-item element four">
										<a href="product_details.php" title="View Detail" >
										<span class="slashc-img-zoom-pan">
											<img alt="Image 01" src="img/product/small/stn621-enlarge.jpg" />
											<img alt="Image 01" src="img/product/large/stn621-large.jpg" />
										</span>
										</a>
										<!-- Offer Details -->
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Casual</a><a href="contact.php" class="btn btn-default pull-right">Buy Now</a><!--<span class="offer-price pull-right"> from $269.0</span>--></h3>
											<!-- Icons And Button -->
											<div class="offer-icons">
												<!-- Icons -->
									...
									<li class="offer-item element four">
										<a href="product_details.php" title="View Detail" >
										<span class="slashc-img-zoom-pan">
											<img alt="Image 01" src="img/product/small/skk15626-enlarge.jpg" />
											<img alt="Image 01" src="img/product/large/skk15626-large.jpg" />
										</span>
										</a>
										<!-- Offer Details -->
										<div class="offer-details">
									...
									<li class="offer-item element four">
										<a href="product_details.php" title="View Detail" >
										<span class="slashc-img-zoom-pan">
											<img alt="Image 01" src="img/product/small/srea73-enlarge.jpg" />
											<img alt="Image 01" src="img/product/large/srea73-large.jpg" />
										</span>
										</a>
										<!-- Offer Details -->
										<div class="offer-details">
