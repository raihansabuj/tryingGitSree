...
<html>
	...
	<body>
		...
		<audio controls autoplay loop  id="audioPlayer" class="">
		  <source src="audio/festival_beautiful_flute_hilly.ogg" type="audio/ogg">
		  <source src="audio/festival_beautiful_flute_hilly.mp3" type="audio/mpeg">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="offer">
								<div class="heading">
									<!-- Heading -->
									<h2>Festival Products <span style="color:#000;font-weight:bold;">Saree House Fashion</span></h2>
								</div>
								...
								<ul id="preview" class="" style="padding:0; margin:0;">
									...
									<li class="offer-item element one">
										...
										<span class="slashc-img-zoom-pan">
											<img alt="Image 01" src="img/product/small/S6919-pf.jpg" />
											<img alt="Image 01" src="img/product/large/l_S6919.jpg" />
										</span>
										</a>
										<!-- Offer Details -->
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Casual</a><span class="offer-price pull-right"> from $49.0</span></h3>
											<!-- Icons And Button -->
									...
									<li class="offer-item element two">
										<a href="product_details.php" title="View Detail" >						
										<span class="slashc-img-zoom-pan">
											<img alt="Image 02" src="img/product/small/lsh29-enlarge-f.jpg" />
											<img alt="Image 02" src="img/product/large/lsh29-large.jpg" />
										</span>
										</a>
										<!-- Offer Details -->
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Casual</a><span class="offer-price pull-right"> from $82.0</span></h3>
											<!-- Icons And Button -->
											<div class="offer-icons">
												<!-- Icons -->
									...
									<li class="offer-item element four">
										<a href="product_details.php" title="View Detail" >
										<span class="slashc-img-zoom-pan">
											<img alt="Image 01" src="img/product/small/C7312-cpf.jpg" />
											<img alt="Image 01" src="img/product/large/l_C7312.jpg" />
										</span>
										</a>
										<!-- Offer Details -->
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Casual</a><span class="offer-price pull-right"> from $269.0</span></h3>
											<!-- Icons And Button -->
											<div class="offer-icons">
												<!-- Icons -->
									...
									<li class="offer-item element four">
										<a href="product_details.php" title="View Detail" >						
										<span class="slashc-img-zoom-pan">
											<img alt="Image 02" src="img/product/small/D6252-cpf.jpg" />
											<img alt="Image 02" src="img/product/large/l_D6252.jpg" />
										</span>
										</a>
										<!-- Offer Details -->
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Casual</a><span class="offer-price pull-right"> from $349.0</span></h3>
											<!-- Icons And Button -->
											<div class="offer-icons">
												<!-- Icons -->
									...
									<li class="offer-item element three">
										<a href="product_details.php" title="View Detail" >
										<span class="slashc-img-zoom-pan">
											<img alt="Image 01" src="img/product/small/R2072-1-pf.jpg" />
											<img alt="Image 01" src="img/product/large/l_R2072-1.jpg" />
										</span>
										</a>
										<!-- Offer Details -->
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Casual</a><span class="offer-price pull-right"> from $223.0</span></h3>
											<!-- Icons And Button -->
											<div class="offer-icons">
												<!-- Icons -->
									...
									<li class="offer-item element one">
										<a href="product_details.php" title="View Detail" >						
										<span class="slashc-img-zoom-pan">
											<img alt="Image 02" src="img/product/small/lsh28-enlarge.jpg" />
											<img alt="Image 02" src="img/product/large/lsh28-large.jpg" />
										</span>
										</a>
										<!-- Offer Details -->
										<div class="offer-details">
									...
									<li class="offer-item element three">
										<a href="product_details.php" title="View Detail" >
										<span class="slashc-img-zoom-pan">
											<img alt="Image 01" src="img/product/small/_O7A3259-pf.jpg" />
											<img alt="Image 01" src="img/product/large/l_O7A3259.jpg" />
										</span>
										</a>
										<!-- Offer Details -->
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Casual</a><span class="offer-price pull-right"> from $228.0</span></h3>
											<!-- Icons And Button -->
											<div class="offer-icons">
												<!-- Icons -->
									...
									<li class="offer-item element two">
										...
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Casual</a><span class="offer-price pull-right"> from $89.0</span></h3>
											<!-- Icons And Button -->
											<div class="offer-icons">
												<!-- Icons -->
