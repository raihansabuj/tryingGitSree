...
<html>
	...
	<body>
		...
		<audio controls autoplay loop  id="audioPlayer" class="">
		  <source src="audio/bridal_hindi_wedding__Mere_Hathon_Main_Nau_Nau_Chodiyan.ogg" type="audio/ogg">
		  <source src="audio/bridal_hindi_wedding__Mere_Hathon_Main_Nau_Nau_Chodiyan.mp3" type="audio/mpeg">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="offer">
								<div class="heading">
									<!-- Heading -->
									<h2>Bridal Products <span style="color:#000;font-weight:bold;">Saree House Fashion</span></h2>
								</div>
								...
								<ul id="preview" class="" style="padding:0; margin:0;">
									...
									<li class="offer-item element four">
										...
										<span class="slashc-img-zoom-pan">
											<img alt="Image 01" src="img/product/small/D6307-cpw.jpg" />
											<img alt="Image 01" src="img/product/large/l_D6307.jpg" />
										</span>
										</a>
										<!-- Offer Details -->
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Bridal</a><span class="offer-price pull-right"> from $358.0</span></h3>
											<!-- Icons And Button -->
									...
									<li class="offer-item element three">
										<a href="product_details.php" title="View Detail" >						
										<span class="slashc-img-zoom-pan">
											<img alt="Image 02" src="img/product/small/lcs76-enlarge-w.jpg" />
											<img alt="Image 02" src="img/product/large/lcs76-large.jpg" />
										</span>
										</a>
										<!-- Offer Details -->
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Bridal</a><span class="offer-price pull-right"> from $114.0</span></h3>
											<!-- Icons And Button -->
											<div class="offer-icons">
												<!-- Icons -->
									...
									<li class="offer-item element four">
										<a href="product_details.php" title="View Detail" >
										<span class="slashc-img-zoom-pan">
											<img alt="Image 01" src="img/product/small/lwk1859-enlarge-b.jpg" />
											<img alt="Image 01" src="img/product/large/lwk1859-large.jpg" />
										</span>
										</a>
										<!-- Offer Details -->
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Bridal</a><span class="offer-price pull-right"> from $436.0</span></h3>
											<!-- Icons And Button -->
											<div class="offer-icons">
												<!-- Icons -->
									...
									<li class="offer-item element four">
										<a href="product_details.php" title="View Detail" >						
										<span class="slashc-img-zoom-pan">
											<img alt="Image 02" src="img/product/small/lwk1851-enlarge-b.jpg" />
											<img alt="Image 02" src="img/product/large/lwk1851-large.jpg" />
										</span>
										</a>
										<!-- Offer Details -->
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Bridal</a><span class="offer-price pull-right"> from $310.0</span></h3>
											<!-- Icons And Button -->
											<div class="offer-icons">
												<!-- Icons -->
									...
									<li class="offer-item element three">
										<a href="product_details.php" title="View Detail" >
										<span class="slashc-img-zoom-pan">
											<img alt="Image 01" src="img/product/small/lxw35-enlarge-b.jpg" />
											<img alt="Image 01" src="img/product/large/lxw35-large.jpg" />
										</span>
										</a>
										<!-- Offer Details -->
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Bridal</a><span class="offer-price pull-right"> from $249.0</span></h3>
											<!-- Icons And Button -->
											<div class="offer-icons">
												<!-- Icons -->
									...
									<li class="offer-item element three">
										<a href="product_details.php" title="View Detail" >						
										<span class="slashc-img-zoom-pan">
											<img alt="Image 02" src="img/product/small/lan28-enlarge.jpg" />
											<img alt="Image 02" src="img/product/large/lan28-large.jpg" />
										</span>
										</a>
										<!-- Offer Details -->
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Bridal</a><span class="offer-price pull-right"> from $199.0</span></h3>
											<!-- Icons And Button -->
											<div class="offer-icons">
												<!-- Icons -->
									...
									<li class="offer-item element three">
										<a href="product_details.php" title="View Detail" >
										<span class="slashc-img-zoom-pan">
											<img alt="Image 01" src="img/product/small/lwk1857-enlarge-w.jpg" />
											<img alt="Image 01" src="img/product/large/lwk1857-large.jpg" />
										</span>
										</a>
										<!-- Offer Details -->
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Bridal</a><span class="offer-price pull-right"> from $179.0</span></h3>
											<!-- Icons And Button -->
											<div class="offer-icons">
												<!-- Icons -->
									...
									<li class="offer-item element two">
										<a href="product_details.php" title="View Detail" >						
										<span class="slashc-img-zoom-pan">
											<img alt="Image 02" src="img/product/small/lan32-enlarge-w.jpg" />
											<img alt="Image 02" src="img/product/large/lan32-large.jpg" />
										</span>
										</a>
										<!-- Offer Details -->
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Bridal</a><span class="offer-price pull-right"> from $89.0</span></h3>
											<!-- Icons And Button -->
											<div class="offer-icons">
												<!-- Icons -->
