...
if(isset($_POST['submit'])){
	...
	if($product_color_name==''){
		...
		$insert_query ="INSERT INTO product_color (product_color_name) values ('$product_color_name')";
...
<div id="page-heading"><h1>Add product color:</h1></div>
...
<tr>
	...
	<td>
		...
		<div id="step-holder">
			...
			<div class="step-dark-left"><a href="">Add product color</a></div>
...
<form method="post" action="#" enctype="multipart/form-data">
	<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
		<tr>
			...
			<td><input type="text" name="product_color_name" class="inp-form" /></td>
			<td></td>
		</tr>
