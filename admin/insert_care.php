...
if(isset($_POST['submit'])){
	...
	if($care_name==''){
		...
		$insert_query ="INSERT INTO care (care_name) values ('$care_name')";
...
<div id="page-heading"><h1>Add product care:</h1></div>
...
<tr>
	...
	<td>
		...
		<div id="step-holder">
			...
			<div class="step-dark-left"><a href="">Add product care</a></div>
...
<form method="post" action="#" enctype="multipart/form-data">
	<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
		<tr>
			...
			<td><input type="text" name="care_name" class="inp-form" /></td>
			<td></td>
		</tr>
