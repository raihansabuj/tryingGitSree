...
$filename1 = "images/small". $_FILES['image']['name'];
   ...
   <div id="con">
		...
		<tr>
          ...
          <td width="350" align="left">
            <div align="left">
              <input size="25" name="image" type="file" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:10pt" class="box"/>
