					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="offer">
								<div class="heading">
									<!-- Heading -->
									<h2>Panjabi and Bed Sheet <span style="color:#000;font-weight:bold;">Saree House Fashion</span></h2>
								</div>
								...
								<ul id="preview" class="" style="padding:0; margin:0;">
									...
									<li class="offer-item element one">
										...
										<span class="slashc-img-zoom-pan">
											<img alt="Image 01" src="img/product/small/mpc432-enlarge.jpg" />
											<img alt="Image 01" src="img/product/large/mpc432-large.jpg" />
										</span>
										</a>
									
										<div class="offer-details">
										
											<h3><a href="product_details.php">Panjabi</a><a href="contact.php" class="btn btn-default pull-right">Buy Now</a><!--<span class="offer-price pull-right"> from $30.0</span>--></h3>
									...
									<li class="offer-item element four">
										<a href="product_details.php" title="View Detail" >						
										<span class="slashc-img-zoom-pan">
											<img alt="Image 02" src="img/product/small/mse284-enlarge.jpg" />
											<img alt="Image 02" src="img/product/large/mse284-large.jpg" />
										</span>
										</a>
										<!-- Offer Details -->
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Panjabi</a><a href="contact.php" class="btn btn-default pull-right">Buy Now</a><!--<span class="offer-price pull-right"> from $269.0</span>--></h3>
											<!-- Icons And Button -->
											<div class="offer-icons">
												<!-- Icons -->
									...
									<li class="offer-item element four">
										<a href="product_details.php" title="View Detail" >
										<span class="slashc-img-zoom-pan">
											<img alt="Image 01" src="img/product/small/mpc434-enlarge.jpg" />
											<img alt="Image 01" src="img/product/large/mpc434-large.jpg" />
										</span>
										</a>
										<!-- Offer Details -->
										<div class="offer-details">
									...
									<li class="offer-item element three">
										...
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Panjabi</a><a href="contact.php" class="btn btn-default pull-right">Buy Now</a><!--<span class="offer-price pull-right"> from $249.0</span>--></h3>
											<!-- Icons And Button -->
											<div class="offer-icons">
												<!-- Icons -->
									...
									<li class="offer-item element one">
										<a href="product_details.php" title="View Detail" >
										<span class="slashc-img-zoom-pan">
											<img alt="Image 01" src="img/product/small/bedsheet1.jpg" />
											<img alt="Image 01" src="img/product/large/bedsheet1-large.jpg" />
										</span>
										</a>
									
										<div class="offer-details">
										
											<h3><a href="product_details.php">Bed Sheet</a><a href="contact.php" class="btn btn-default pull-right">Buy Now</a><!--<span class="offer-price pull-right"> from $30.0</span>--></h3>
									...
									<li class="offer-item element two">
										...
										<div class="offer-details">
											...
											<h3><a href="product_details.php">Bed Sheet</a><a href="contact.php" class="btn btn-default pull-right">Buy Now</a><!--<span class="offer-price pull-right"> from $69.0</span>--></h3>
									...
									<li class="offer-item element four">
										<a href="product_details.php" title="View Detail" >						
										<span class="slashc-img-zoom-pan">
											<img alt="Image 02" src="img/product/small/bedsheet3.jpg" />
											<img alt="Image 02" src="img/product/large/bedsheet3-large.jpg" />
										</span>
										</a>
										<!-- Offer Details -->
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Bed Sheet</a><a href="contact.php" class="btn btn-default pull-right">Buy Now</a><!--<span class="offer-price pull-right"> from $269.0</span>--></h3>
											<!-- Icons And Button -->
											<div class="offer-icons">
												<!-- Icons -->
