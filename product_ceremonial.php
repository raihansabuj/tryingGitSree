					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="offer">
								<div class="heading">
									<!-- Heading -->
									<h2>Ceremonial Products <span style="color:#000;font-weight:bold;">Saree House Fashion</span></h2>
								</div>
								...
								<ul id="preview" class="" style="padding:0; margin:0;">
									...
									<li class="offer-item element one">
										...
										<span class="slashc-img-zoom-pan">
											<img alt="Image 01" src="img/product/thumb/saree(41).jpg" />
											<img alt="Image 01" src="img/product/large/saree(41).jpg" />
										</span>
										</a>
									
										<div class="offer-details">
										
											<h3><a href="product_details.php">Cerimonial</a><span class="offer-price pull-right"> from $30.0</span></h3>
									...
									<li class="offer-item element two">
										<a href="product_details.php" title="View Detail" >						
										<span class="slashc-img-zoom-pan">
											<img alt="Image 02" src="img/product/thumb/saree(42).jpg" />
											<img alt="Image 02" src="img/product/large/saree(42).jpg" />
										</span>
										</a>
										
										<div class="offer-details">
											
											<h3><a href="product_details.php">Cerimonial</a><span class="offer-price pull-right"> from $69.0</span></h3>
									...
									<li class="offer-item element four">
										...
										<div class="offer-details">
											...
											<h3><a href="product_details.php">Ceremonial</a><span class="offer-price pull-right"> from $269.0</span></h3>
											<!-- Icons And Button -->
											<div class="offer-icons">
												<!-- Icons -->
									...
									<li class="offer-item element four">
										...
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Ceremonial</a><span class="offer-price pull-right"> from $295.0</span></h3>
											<!-- Icons And Button -->
											<div class="offer-icons">
												<!-- Icons -->
									...
									<li class="offer-item element three">
										...
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Ceremonial</a><span class="offer-price pull-right"> from $249.0</span></h3>
											<!-- Icons And Button -->
											<div class="offer-icons">
												<!-- Icons -->
									...
									<li class="offer-item element four">
										...
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Ceremonial</a><span class="offer-price pull-right"> from $358.0</span></h3>
											<!-- Icons And Button -->
											<div class="offer-icons">
												<!-- Icons -->
									...
									<li class="offer-item element three">
										...
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Ceremonial</a><span class="offer-price pull-right"> from $228.0</span></h3>
											<!-- Icons And Button -->
											<div class="offer-icons">
												<!-- Icons -->
									...
									<li class="offer-item element four">
										...
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Ceremonial</a><span class="offer-price pull-right"> from $285.0</span></h3>
											<!-- Icons And Button -->
											<div class="offer-icons">
												<!-- Icons -->
