...
<html>
	...
	<body>
		...
		<!-- Style Switcher End -->
		<audio controls autoplay id="audioPlayer" class="style-switcher">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="offer">
								<div class="heading">
									<!-- Heading -->
									<h2>Our Products <span style="color:#000;font-weight:bold;">Saree House Fashion</span></h2>
								</div>
								...
								<ul id="filters">
									...
									<li><a href="#" data-filter=".three" class="btn btn-default">$100-$149</a></li>
								...
								<ul id="preview" class="" style="padding:0; margin:0;">
									...
									<li class="offer-item element one">
										...
										<span class="slashc-img-zoom-pan">
											<img alt="Image 01" src="img/product/thumb/saree(1).jpg" />
											<img alt="Image 01" src="img/product/large/saree(1).jpg" />
										</span>
										</a>
										<!-- Offer Details -->
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Casual</a><span class="offer-price pull-right">$30.0</span></h3>
											<!-- Icons And Button -->
									...
									<li class="offer-item element two">
										<a href="product_details.php" title="View Detail" >						
										<span class="slashc-img-zoom-pan">
											<img alt="Image 02" src="img/product/thumb/saree(2).jpg" />
											<img alt="Image 02" src="img/product/large/saree(2).jpg" />
										</span>
										</a>
										<!-- Offer Details -->
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Casual</a><span class="offer-price pull-right">$69.0</span></h3>
											<!-- Icons And Button -->
											<div class="offer-icons">
												<!-- Icons -->
												<a href="product_details.php"><i class="fa fa-heart"></i></a>
									...
									<li class="offer-item element four">
										<a href="product_details.php" title="View Detail" >
										<span class="slashc-img-zoom-pan">
											<img alt="Image 01" src="img/product/thumb/saree(3).jpg" />
											<img alt="Image 01" src="img/product/large/saree(3).jpg" />
										</span>
										</a>
										<!-- Offer Details -->
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Casual</a><span class="offer-price pull-right">$300.0</span></h3>
											<!-- Icons And Button -->
											<div class="offer-icons">
												<!-- Icons -->
												<a href="product_details.php"><i class="fa fa-heart"></i></a>
									...
									<li class="offer-item element four">
										<a href="product_details.php" title="View Detail" >						
										<span class="slashc-img-zoom-pan">
											<img alt="Image 02" src="img/product/thumb/saree(4).jpg" />
											<img alt="Image 02" src="img/product/large/saree(4).jpg" />
										</span>
										</a>
										<!-- Offer Details -->
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Casual</a><span class="offer-price pull-right">$349.0</span></h3>
											<!-- Icons And Button -->
											<div class="offer-icons">
												<!-- Icons -->
												<a href="product_details.php"><i class="fa fa-heart"></i></a>
									...
									<li class="offer-item element three">
										<a href="product_details.php" title="View Detail" >
										<span class="slashc-img-zoom-pan">
											<img alt="Image 01" src="img/product/thumb/saree(5).jpg" />
											<img alt="Image 01" src="img/product/large/saree(5).jpg" />
										</span>
										</a>
										<!-- Offer Details -->
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Casual</a><span class="offer-price pull-right">$129.0</span></h3>
											<!-- Icons And Button -->
											<div class="offer-icons">
												<!-- Icons -->
												<a href="product_details.php"><i class="fa fa-heart"></i></a>
									...
									<li class="offer-item element one">
										<a href="product_details.php" title="View Detail" >						
										<span class="slashc-img-zoom-pan">
											<img alt="Image 02" src="img/product/thumb/saree(6).jpg" />
											<img alt="Image 02" src="img/product/large/saree(6).jpg" />
										</span>
										</a>
										<!-- Offer Details -->
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Casual</a><span class="offer-price pull-right">$49.0</span></h3>
											<!-- Icons And Button -->
											<div class="offer-icons">
												<!-- Icons -->
												<a href="product_details.php"><i class="fa fa-heart"></i></a>
									...
									<li class="offer-item element three">
										<a href="product_details.php" title="View Detail" >
										<span class="slashc-img-zoom-pan">
											<img alt="Image 01" src="img/product/thumb/saree(7).jpg" />
											<img alt="Image 01" src="img/product/large/saree(7).jpg" />
										</span>
										</a>
										<!-- Offer Details -->
										<div class="offer-details">
									...
									<li class="offer-item element two">
										<a href="product_details.php" title="View Detail" >						
										<span class="slashc-img-zoom-pan">
											<img alt="Image 02" src="img/product/thumb/saree(8).jpg" />
											<img alt="Image 02" src="img/product/large/saree(8).jpg" />
										</span>
										</a>
										<!-- Offer Details -->
										<div class="offer-details">
											<!-- Product Title / Heading -->
											<h3><a href="product_details.php">Casual</a><span class="offer-price pull-right">$89.0</span></h3>
											<!-- Icons And Button -->
											<div class="offer-icons">
												<!-- Icons -->
												<a href="product_details.php"><i class="fa fa-heart"></i></a>
